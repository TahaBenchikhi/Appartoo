...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'prenom', 'famille', 'race', 'nom', 'nourriture', 'age', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'friends', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getNourriture()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNourriture', []);

        return parent::getNourriture();
    }
    ...
    public function getFriendsList()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFriendsList', []);

        return parent::getFriendsList();
    }
